...
test: minicc
	...
	bash ./test/integer_return_abi.sh
	...
	bash ./test/indirect_variadic_abi.sh
	bash ./test/indirect_oldstyle_abi.sh
	...
	bash ./test/record_callback_return_abi.sh
