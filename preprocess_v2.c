...
static char *get_builtin_header(char *name) {
    if (!strcmp(name, "math.h")) {
        return "#ifndef __MINICC_MATH_H\n"
               ...
               "union __minicc_math_d_bits { double d; unsigned long u; };\n"
               "union __minicc_math_f_bits { float f; unsigned int u; };\n"
               "union __minicc_math_l_bits { long double x; unsigned long u[2]; };\n"
               "static inline int __minicc_isnan(double x) { return x != x; }\n"
               "static inline int __minicc_isinf(double x) { return !__minicc_isnan(x) && x != 0.0 && x + x == x; }\n"
               "static inline int __minicc_isfinite(double x) { return !__minicc_isnan(x) && !__minicc_isinf(x); }\n"
               "static inline int __minicc_isnanl(long double x) { return x != x; }\n"
               ...
               "static inline int __minicc_signbit(double x) { union __minicc_math_d_bits v; v.d=x; return (int)(v.u >> 63); }\n"
               "static inline int __minicc_signbitl(long double x) { union __minicc_math_l_bits v; v.x=x; return (int)((v.u[1] >> 15) & 1UL); }\n"
               "static inline int __minicc_fpclassify(double x) { union __minicc_math_d_bits v; unsigned long e, f; v.d=x; e=(v.u >> 52) & 0x7ffUL; f=v.u & 0xfffffffffffffUL; if (e==0x7ffUL) return f ? FP_NAN : FP_INFINITE; if (!e) return f ? FP_SUBNORMAL : FP_ZERO; return FP_NORMAL; }\n"
               "static inline int __minicc_fpclassifyf(float x) { union __minicc_math_f_bits v; unsigned int e, f; v.f=x; e=(v.u >> 23) & 0xffU; f=v.u & 0x7fffffU; if (e==0xffU) return f ? FP_NAN : FP_INFINITE; if (!e) return f ? FP_SUBNORMAL : FP_ZERO; return FP_NORMAL; }\n"
               "static inline int __minicc_fpclassifyl(long double x) { union __minicc_math_l_bits v; unsigned long e, f; v.x=x; e=v.u[1] & 0x7fffUL; f=v.u[0]; if (e==0x7fffUL) return (f & 0x7fffffffffffffffUL) ? FP_NAN : FP_INFINITE; if (!e) return f ? FP_SUBNORMAL : FP_ZERO; return FP_NORMAL; }\n"
               "static inline int __minicc_isgreater(double x,double y){return !__minicc_isnan(x)&&!__minicc_isnan(y)&&x>y;}\n"
               "static inline int __minicc_isgreaterequal(double x,double y){return !__minicc_isnan(x)&&!__minicc_isnan(y)&&x>=y;}\n"
               "static inline int __minicc_isless(double x,double y){return !__minicc_isnan(x)&&!__minicc_isnan(y)&&x<y;}\n"
               "static inline int __minicc_islessequal(double x,double y){return !__minicc_isnan(x)&&!__minicc_isnan(y)&&x<=y;}\n"
               "static inline int __minicc_islessgreater(double x,double y){return !__minicc_isnan(x)&&!__minicc_isnan(y)&&(x<y||x>y);}\n"
               "static inline int __minicc_isunordered(double x,double y){return __minicc_isnan(x)||__minicc_isnan(y);}\n"
               "static inline int __minicc_isgreaterl(long double x,long double y){return !__minicc_isnanl(x)&&!__minicc_isnanl(y)&&x>y;}\n"
               ...
               "#define fpclassify(x) _Generic((x), float: __minicc_fpclassifyf, long double: __minicc_fpclassifyl, default: __minicc_fpclassify)((x))\n"
               ...
               "double acos(double); float acosf(float); double asin(double); float asinf(float);\n"
               "double atan(double); float atanf(float); double atan2(double,double); float atan2f(float,float);\n"
               "double cos(double); float cosf(float); double sin(double); float sinf(float); double tan(double); float tanf(float);\n"
               "double acosh(double); float acoshf(float); double asinh(double); float asinhf(float); double atanh(double); float atanhf(float);\n"
               "double cosh(double); float coshf(float); double sinh(double); float sinhf(float); double tanh(double); float tanhf(float);\n"
               "double exp(double); float expf(float); double exp2(double); float exp2f(float); double expm1(double); float expm1f(float);\n"
               "double frexp(double,int *); float frexpf(float,int *); double ldexp(double,int); float ldexpf(float,int);\n"
               "double log(double); float logf(float); double log10(double); float log10f(float); double log1p(double); float log1pf(float); double log2(double); float log2f(float);\n"
               "double modf(double,double *); float modff(float,float *); double scalbn(double,int); float scalbnf(float,int); double scalbln(double,long); float scalblnf(float,long);\n"
               "int ilogb(double); int ilogbf(float); double logb(double); float logbf(float);\n"
               "double cbrt(double); float cbrtf(float); double hypot(double,double); float hypotf(float,float); double pow(double,double); float powf(float,float); double sqrt(double); float sqrtf(float);\n"
               "double erf(double); float erff(float); double erfc(double); float erfcf(float); double lgamma(double); float lgammaf(float); double tgamma(double); float tgammaf(float);\n"
               "double ceil(double); float ceilf(float); double floor(double); float floorf(float); double nearbyint(double); float nearbyintf(float); double rint(double); float rintf(float); double round(double); float roundf(float); double trunc(double); float truncf(float);\n"
               "long lrint(double); long lrintf(float); long lround(double); long lroundf(float); long long llrint(double); long long llrintf(float); long long llround(double); long long llroundf(float);\n"
               "double fmod(double,double); float fmodf(float,float); double remainder(double,double); float remainderf(float,float); double remquo(double,double,int *); float remquof(float,float,int *);\n"
               "double copysign(double,double); float copysignf(float,float); double nan(const char *); float nanf(const char *); double nextafter(double,double); float nextafterf(float,float);\n"
               "double fdim(double,double); float fdimf(float,float); double fmax(double,double); float fmaxf(float,float); double fmin(double,double); float fminf(float,float); double fabs(double); float fabsf(float); double fma(double,double,double); float fmaf(float,float,float);\n"
