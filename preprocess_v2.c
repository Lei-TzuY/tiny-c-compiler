...
static char *get_builtin_header(char *name) {
    ...
    if (!strcmp(name, "math.h")) {
        return "#ifndef __MINICC_MATH_H\n"
               ...
               "#define fpclassify(x) _Generic((x), float: __minicc_fpclassifyf, default: __minicc_fpclassify)((x))\n"
    ...
    if (!strcmp(name, "stdatomic.h")) {
        return "#ifndef __MINICC_STDATOMIC_H\n"
               "#define __MINICC_STDATOMIC_H 1\n"
